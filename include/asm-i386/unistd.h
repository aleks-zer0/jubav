...
static inline _syscall0(int,clone)
static inline _syscall2(int,kill,int, pid, int, sig)
static inline _syscall3(int,open,const char *,file,int,flag,int,mode)
static inline _syscall3(int,sigaction,int,sig,struct sigaction_s *, act, struct sigaction_s *,oldact)
static inline _syscall1(int,sigreturn,unsigned long,_unused)
